...
plt_nonzero_fraction_corr <- function(dataset2plot, df_nonzero_fraction) {
  ...
  ggsave(file.path(results_dir, paste0("col_imp_vs_true_nzf_", dataset2plot, ".png")), device = agg_png, width = 10, height = 6.5, units = "cm", dpi = 300, scaling = 0.8) 
  ggsave(file.path(results_dir, paste0("col_imp_vs_true_nzf_", dataset2plot, ".pdf")), width = 10, height = 6.5, units = "cm", scale = 1/0.8) 
}
